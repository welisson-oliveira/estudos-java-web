...
public class FinanceiroWSServiceLocator extends org.apache.axis.client.Service implements financeiro.webservice.FinanceiroWSService {
    ...
    private java.lang.String FinanceiroWSPort_address = "http://localhost:8080/FinanceiroWeb/webservice/financeiroWS";
    ...
    public financeiro.webservice.FinanceiroWS getFinanceiroWSPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            financeiro.webservice.FinanceiroWSPortBindingStub _stub = new financeiro.webservice.FinanceiroWSPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (financeiro.webservice.FinanceiroWS.class.isAssignableFrom(serviceEndpointInterface)) {
                financeiro.webservice.FinanceiroWSPortBindingStub _stub = new financeiro.webservice.FinanceiroWSPortBindingStub(new java.net.URL(FinanceiroWSPort_address), this);
                _stub.setPortName(getFinanceiroWSPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservice.financeiro/", "FinanceiroWSService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservice.financeiro/", "FinanceiroWSPort"));
        }
