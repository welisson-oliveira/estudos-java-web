...
public class FinanceiroWSProxy implements financeiro.webservice.FinanceiroWS {
  private String _endpoint = null;
  private financeiro.webservice.FinanceiroWS financeiroWS = null;
  ...
  private void _initFinanceiroWSProxy() {
    try {
      financeiroWS = (new financeiro.webservice.FinanceiroWSServiceLocator()).getFinanceiroWSPort();
  ...
  public financeiro.webservice.FinanceiroWS getFinanceiroWS() {
    if (financeiroWS == null)
      _initFinanceiroWSProxy();
    return financeiroWS;
  }
