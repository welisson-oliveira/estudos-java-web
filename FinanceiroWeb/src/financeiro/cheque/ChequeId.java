...
@Embeddable  // indica que a classe não precisa de um identificador próprio. Isso se da pq objetos dessa natureza são identificados pelos objetos da entidade nos quais estão contidos.
public class ChequeId  implements Serializable{
	
	/**
	 * 
	 */
	private static final long serialVersionUID = 2729057323543487932L;
